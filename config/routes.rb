RolemWeb::Application.routes.draw do
  ...
  scope '(:locale)', :locale => /es|en/ do
    ...
    match '/productos/Small/ZBOX-EN760', to: 'static_pages#ZBOX-EN760'
    match '/productos/Small/Nano-nT-A3800', to: 'static_pages#Nano-nT-A3800'
    match '/productos/Small/raven', to:'static_pages#raven'
    match '/productos/Small/volcanoA', to: 'static_pages#volcanoA'
    match '/productos/Small/volcanoIN', to: 'static_pages#volcanoIN'
    match '/productos/Small/prodigy', to: 'static_pages#prodigy'
    match '/productos/Small/optimus', to: 'static_pages#optimus'
    match '/productos/Small/force', to: 'static_pages#force'
    match '/productos/Small/elemento', to: 'static_pages#elemento'
    match '/productos/Small/elementoM', to: 'static_pages#elementoM'
